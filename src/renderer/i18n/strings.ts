...
const strings = {
  ...
  'canvas.fitPanelsThreePanelLayout': { en: '3-panel fit layout', ko: '패널 3개 맞춤 레이아웃' },
  'canvas.fitPanelsThreePanelLayout.desc': { en: 'Layout for "Fit Panels to Screen" (⌘5) when exactly 3 panels are open.', ko: '패널이 정확히 3개일 때 "패널을 화면에 맞추기"(⌘5)에 적용되는 레이아웃.' },
  'canvas.fitPanelsThreePanelLayout.vertical': { en: 'Vertical (default)', ko: '세로 (기본값)' },
  'canvas.fitPanelsThreePanelLayout.horizontal': { en: 'Horizontal (2 top, 1 wide bottom)', ko: '가로 (위 2개, 아래 1개 넓게)' },
